...
#include "examples_basic__main.h"
...
void main_init(kk_context_t* _ctx) {
  kk_examples_basic__main__init(_ctx);
}
void main_run(kk_context_t* _ctx) {
  kk_examples_basic__main__main(_ctx);
}
void main_done(kk_context_t* _ctx) {
  kk_examples_basic__main__done(_ctx);
}
